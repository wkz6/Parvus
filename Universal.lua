...
local Window = Parvus.Utilities.UI:Window({
    ...
    local CombatTab = Window:Tab({Name = "Combat"}) do
        ...
        local AimbotSection = CombatTab:Section({Name = "Aimbot", Side = "Left"}) do
            ...
            AimbotSection:Slider({Name = "Field Of View", Flag = "Aimbot/FOV/Radius", Min = 0, Max = 1080, Value = 100, Unit = "r"})
        ...
        local SilentAimSection = CombatTab:Section({Name = "Silent Aim", Side = "Right"}) do
            ...
            SilentAimSection:Slider({Name = "Field Of View", Flag = "SilentAim/FOV/Radius", Min = 0, Max = 1080, Value = 100, Unit = "r"})
        ...
        local TriggerSection = CombatTab:Section({Name = "Trigger", Side = "Right"}) do
            ...
            TriggerSection:Slider({Name = "Field Of View", Flag = "Trigger/FOV/Radius", Min = 0, Max = 1080, Value = 25, Unit = "r"})
...
local function SolveTrajectory(Origin, Velocity, Time, Gravity)
    ...
    GravityCorrection = GravityCorrection or 1 
